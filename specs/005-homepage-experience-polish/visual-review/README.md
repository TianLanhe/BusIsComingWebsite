...
| 文件 | 视口 | 状态 | 检查项 |
|------|------|------|--------|
| `desktop-1440-carousel-rail.png` | 1440 x 960 | 首屏轮播 | 单主图、低旋转阶梯牌堆、后方图底部不低于主图、无底部缩略图、无编号、无常驻箭头 |
| `mobile-390-carousel-rail.png` | 390 x 844 | 首屏轮播 | 轮播和文案上下组织、手机端收敛牌堆、触控区域可用、无重叠 |
...
- 截图结论：4 张必交截图均已生成；轮播为单主图与低旋转阶梯牌堆，后方图片底部不低于主图底部，没有底部小图堆叠、胶片条、缩略图按钮组、`01/02/03/04` 编号或常驻左右箭头。
