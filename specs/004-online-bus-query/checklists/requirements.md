...
- The required Figma `Online Query v2` desktop and mobile nodes have been created and recorded. The spec records node URLs and the feature is ready for `/speckit-plan`.
