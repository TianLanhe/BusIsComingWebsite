...
export const detailCopy = {
  "zh-Hans": {
    ...
    previousPage: "上一页", requestSuccess: "成功率", requests: "请求数", noDetailData: "当前工作区暂无结果", noDetailBody: "调整时间范围或筛选条件后再查看。",
  },
  "zh-Hant": {
    ...
    previousPage: "上一頁", requestSuccess: "成功率", requests: "請求數", noDetailData: "目前工作區暫無結果", noDetailBody: "調整時段或篩選條件後再查看。",
  },
  en: {
    ...
    previousPage: "Previous page", requestSuccess: "Success rate", requests: "Requests", noDetailData: "No results in this workspace", noDetailBody: "Try a different date range or filter selection.",
  },
