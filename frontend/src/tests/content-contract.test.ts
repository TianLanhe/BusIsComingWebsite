...
describe("content contracts", () => {
  ...
  it("validates the approved v3 homepage content", () => {
    ...
    expect(homepageContent.metadata.version).toBe("3.0.0");
  ...
  it("keeps the new product position and approved interaction contract", () => {
    ...
    expect(homepageContent.figmaReference).toEqual(expect.objectContaining({
      sectionNode: "119:64",
