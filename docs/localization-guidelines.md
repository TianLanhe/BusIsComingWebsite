...
- 使用香港实用书面语，清楚、自然、可信。
- 总体产品定位优先使用“巴士”“路線”“車費”“抵站時間／ETA”“私隱”“下載”等香港产品页面习惯；只有说明真实数据来源或联营班次时才使用具体运营商名称。
...
- 具体运营商名称、香港地点、路线号、HK$ 和官方来源名称保持原义。
...
| --- | --- |
| 产品名 | `BusIsComing` |
| 运营商/来源 | 总体定位写“巴士”；具体来源按事实写 `Citybus`、城巴、九巴或龙运 |
...
网站中的路线试查当前使用 Citybus 路线数据，但 App 的总体定位是香港巴士路线规划与导航，不绑定单一运营商。中文“行程”“路线”“乘车段”和英文 journey/route/leg 不可随意互换，以免把起终点配置、乘车方案和完整规划混为一谈。
